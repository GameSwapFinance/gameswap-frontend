  ...
  const data = await Promise.all(
    farmsConfig.map(async (farmConfig) => {
      ...
      if (farmConfig.isTokenOnly) {
        ...
        if ((farmConfig.tokenSymbol === QuoteToken.CORN || farmConfig.tokenSymbol === QuoteToken.WMATIC || farmConfig.tokenSymbol === QuoteToken.QUICK || farmConfig.tokenSymbol === QuoteToken.WETH || farmConfig.tokenSymbol === QuoteToken.FISH || farmConfig.tokenSymbol === QuoteToken.IRON || farmConfig.tokenSymbol === QuoteToken.POLYDOGE || farmConfig.tokenSymbol === QuoteToken.DAI || farmConfig.tokenSymbol === QuoteToken.SGAJ) && farmConfig.quoteTokenSymbol === QuoteToken.BUSD) {
